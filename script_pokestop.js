...
var gruntDict = {4:"grunt",5:"grunt",6:"bug",7:"bug",48:"ghost",47:"ghost",10:"dark",11:"dark",12:"dragon",13:"dragon",14:"fairy",15:"fairy",16:"fighting",17:"fighting",18:"fire",19:"fire",20:"flying",21:"flying",22:"grass",23:"grass",24:"ground",25:"ground",26:"ice",27:"ice",28:"metal",29:"metal",30:"normal",31:"normal",32:"poison",33:"poison",34:"psychic",35:"psychic",36:"rock",37:"rock",38:"water",39:"water",49:"electric",50:"electric",41:"cliff",42:"arlo",43:"sierra",44:"giovanni",500: "npc",501: "npc",502: "npc",503: "npc",504: "npc",505: "npc",506: "npc",507: "npc",508: "npc",509: "npc",510: "npc"};
...
function getAssetURL(pokestop) {  
	if (pokestop.invasion_end) {
		return '/images/pokestop/rocket.png?ver666'
	};
...
function getTypeURL(pokestop) {
	return '/images/pokestop/type_' + pokestop.invasionType() + '.png?ver666';
}
...
function Pokestop(lat, lng, pokestop_name, invasion_end, invasion_character, lure_type, lure_end) {
  ...
  this.gender = function() {
    if (males.indexOf(this.invasion_character) != -1) {
      return 1;
    }
    else if (females.indexOf(this.invasion_character) != -1) {
      return 2;
    }
	...
	if (invasion_character!=45&&invasion_character!=43&invasion_character!=42)
	setTimeout(console.log.bind(console, 
								gruntDict["" + parseInt(invasion_character)]
							   +" "+lat+";"+lng+ " dsp "+
								 timeToString(this.invasion_end-Math.floor(Date.now() / 1000))
							   )
			  );
}
...
function locateMeButton() {
  ...
  map.on('locationfound', function (e) {
    ...
    if (!locationMarker) {
      var iconOptions = {
        iconUrl: 'images/your_location.png?ver666',
        iconAnchor: [12, 25],
        iconSize: [25, 25],
        zIndexOffset: 1000
      }  
...
function infoWindowString(pokestop) {
  ...
  if (gruntType == 'arlo' || gruntType == 'cliff' || gruntType == 'sierra') {
	...
	navigator.clipboard.writeText(pokestop.lat + ";" + pokestop.lng);
...
<strong>Grunt Type: </strong>" + genderString + capitalizedFirstChar(gruntType) + "<br/>\
<strong>Pókestop Name:</strong> " + pokestop.pokestop_name + endTime + "<br/><br/>\
<a target='_blank' href='https://maps.google.com/maps?q=" + pokestop.lat + "," + pokestop.lng + "'>Maps</a>";
}
...
function initMap() {
  $(document).ready(function() {
    ...
    if (randomNumber <= 0.5) {
      if (localStorage.getItem('openPokestopFilter') != '1') {
        setTimeout(showFilterQuestMapToast, 1000);
      }
      else {
        randomNumber = 1;
      }
    ...
    var center = [40.696336, -73.923997];
    var zoomLevel = 11;
    if (window.mobilecheck()) {
      zoomLevel = 10;
    }
    ...
    // var tilesServer = 'https://sgpokemap.com/images/sgpokemap.png';
    // var tilesServer = 'https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
